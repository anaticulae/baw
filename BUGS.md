...
- [x] problem when activating venv on windows. Pay attation to the dot (.)
      after 850 this will leads to an error, when deactivating at the end.
...
- [ ] v0.0.0 version tag after using `baw --init`
...
- [ ] `baw --virtual --test=stash: It stashes every untracked change, the venv
      is also an untracked change and there removed.
