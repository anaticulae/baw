...
- **resource**: Do not use file types
  ([`47e1e6c`](https://github.com/anaticulae/baw/commit/47e1e6cd84630750017fdcb68fd128b56e37cc6f))

- **semantic**: Do not update python file just toml
  ([`777f2dc`](https://github.com/anaticulae/baw/commit/777f2dcb08cb6d032b4bb8c535454c65e56286e8))

- **template**: Add version upgrade command
  ([`be56ae9`](https://github.com/anaticulae/baw/commit/be56ae94fd0aec5cd6deeb50570cb86847bd7683))

- **template**: Adjust default template
  ([`f2b578b`](https://github.com/anaticulae/baw/commit/f2b578bcf88dcd0ea5577488a78e0272ed1d2672))

- **template**: Remove baw code
  ([`b5f5ec6`](https://github.com/anaticulae/baw/commit/b5f5ec6ead3e9a28d12d08ab51495145d1815615))

### Chores

- **toml**: Adjust version number
  ([`5aa1b14`](https://github.com/anaticulae/baw/commit/5aa1b14a5dd57e8f752d9c9c68ed0eb9fe8b097c))

### Code Style

- **test**: Organize imports
  ([`e633588`](https://github.com/anaticulae/baw/commit/e633588f7aeba842416f72eb105409aa47d923be))

### Features

- **config**: Determine version out of toml
  ([`cc5b9f4`](https://github.com/anaticulae/baw/commit/cc5b9f4d2e130652147938b07deb90cd074ffef7))

- **git**: Use more modern default branch name
  ([`836dffe`](https://github.com/anaticulae/baw/commit/836dffefb985017029f698c2ee428d3d34df38ad))

- **init**: Generate LICENSE file
  ([`73a947c`](https://github.com/anaticulae/baw/commit/73a947cc5a03271a677e1c4a970995b313191074))

- **release**: Add option to skip pushing to hvcs
  ([`5bfc18d`](https://github.com/anaticulae/baw/commit/5bfc18d9ecb74f38ce71507b6e6bd2c7892c28a6))

- **semantic**: Improve build command
  ([`c7c313b`](https://github.com/anaticulae/baw/commit/c7c313bee3ae3e3159887464e1aa3ac068663a8f))

### Testing

- **release**: Ensure that version is upgraded
  ([`6b0ad5e`](https://github.com/anaticulae/baw/commit/6b0ad5ee53de5f0fc99176300dd0fb44925e10f0))
...
- **alias**: Remove virtual parameter
  ([`c8eea3d`](https://github.com/anaticulae/baw/commit/c8eea3dd3492ce406a92c5d2e6e5b43acec3cba0))

- **project**: Adjust test
  ([`2633f3f`](https://github.com/anaticulae/baw/commit/2633f3f06aee696fc9a8744a685c00d7408c3ceb))

- **sync**: Do not determine baw root
  ([`3eb9792`](https://github.com/anaticulae/baw/commit/3eb979259634066eb9b0fce3a7133f0bba97f1d5))

- **sync**: Do not fail on missing root
  ([`eeea075`](https://github.com/anaticulae/baw/commit/eeea0758628197fc30e688f28d2648f12be4e2cc))

- **utils**: Do not fail on failing regex
  ([`61164dd`](https://github.com/anaticulae/baw/commit/61164dda955f67ed02a3766d21c92f77cd3e6ff8))

- **version**: Add missing var
  ([`cd278cc`](https://github.com/anaticulae/baw/commit/cd278ccbb9eeec1bb3b464155dbe89ea71959a83))

### Chores

- **docker**: Adjust setup
  ([`fc98c93`](https://github.com/anaticulae/baw/commit/fc98c93b73a2a3e066790ba64f97d99d38d2eaa3))

- **docker**: Adjust to new build env
  ([`cc3a393`](https://github.com/anaticulae/baw/commit/cc3a39376af1052e13f4f04f774d1a47978592e9))

- **pyproject**: Add modern build env
  ([`479f4bc`](https://github.com/anaticulae/baw/commit/479f4bc52963599650ca3b296dd47652fff02797))

- **release**: 1.75.0
  ([`20c08ac`](https://github.com/anaticulae/baw/commit/20c08aca72fd2ce6e4607d2dce9411365b4b9e11))

- **requirements**: Remove outdated requirements
  ([`9f2bdff`](https://github.com/anaticulae/baw/commit/9f2bdffec0082b43660a20ec17e749a3bd5f8a2a))

- **resource**: Adjust project generator
  ([`5a7eb09`](https://github.com/anaticulae/baw/commit/5a7eb0978999b3384c2499e9f6987e177c04b78a))

- **setup**: Change to pyproject
  ([`d191337`](https://github.com/anaticulae/baw/commit/d191337ab739fcfff2df482c3e7da892ec6f9894))

- **setup**: Define version variable
  ([`c81ae27`](https://github.com/anaticulae/baw/commit/c81ae27c8fd5d2596b486da949e769fbb5be46b3))

- **setup**: Remove old setup
  ([`e62125c`](https://github.com/anaticulae/baw/commit/e62125c13e2868ff4515b179b7128af1cbc38330))

- **setup**: Remove outdated setup
  ([`9b4b2fb`](https://github.com/anaticulae/baw/commit/9b4b2fbd2978a7e26dae3a61af6d19c7ff8eda7d))

### Code Style

- **cli**: Add missing import
  ([`15494cd`](https://github.com/anaticulae/baw/commit/15494cd78a349c7476e4d9609e19a7a3c65765bd))

- **test**: Organize imports
  ([`f2259e4`](https://github.com/anaticulae/baw/commit/f2259e4d4c440d230252e7797874e5ba628208b7))

### Documentation

- **project**: Extend interface documentation
  ([`5ef8913`](https://github.com/anaticulae/baw/commit/5ef8913324a5bf8d5b3282a351e82a18bf49be70))

### Features

- **cmd**: Replace verbose with verbose level
  ([`b494cda`](https://github.com/anaticulae/baw/commit/b494cda4532b7bdd4270ac9aa2bcaff46017e9c5))

- **sync**: Add method to determine requirements out of pytoml
  ([`0481429`](https://github.com/anaticulae/baw/commit/0481429451c58684b28e00d54eab413f3e46a0b0))

- **sync**: Determine requirements out of meta definition
  ([`63bbc20`](https://github.com/anaticulae/baw/commit/63bbc2059b3ebcc1f55dacc25867d10d83974535))

- **sync**: Use pytoml requirements
  ([`cd6b191`](https://github.com/anaticulae/baw/commit/cd6b1913106b60c29a14257c217a816f64c560b1))

- **version**: Use metadata to determine version
  ([`8569d93`](https://github.com/anaticulae/baw/commit/8569d93a115283088d03a02e6cdadb852376fe77))

### Refactoring

- **clean**: Solve import error
  ([`d7af5a2`](https://github.com/anaticulae/baw/commit/d7af5a2dbfafcb0f96078c9801c0ec3612bbe4c9))

- **config**: Add mssing space
  ([`bebed03`](https://github.com/anaticulae/baw/commit/bebed03fd6eb19d49f66c667a1b9d1af81367411))

- **project**: Adjust linter
  ([`6c32100`](https://github.com/anaticulae/baw/commit/6c32100abd4979d5ba4030a982009e3231547b47))

- **sync**: Add missing import
  ([`d1aa748`](https://github.com/anaticulae/baw/commit/d1aa7484ee477d28c6fbf06c182b0f05bb6e9776))

- **sync**: Improve code style
  ([`a70d611`](https://github.com/anaticulae/baw/commit/a70d611fcbb1f0277325f4cea84ddc73b7b969c4))

### Testing

- **refactor**: Clarify test
  ([`6c5752d`](https://github.com/anaticulae/baw/commit/6c5752dacb1de8efc1ca45387105c23358ba3fc6))
...
- **refactor**: Use utilo
  ([`aa7b4b2`](https://github.com/anaticulae/baw/commit/aa7b4b224ffb1797dd94b964476c3c90e47f00e4))

- **release**: 1.74.0
  ([`c6d0aba`](https://github.com/anaticulae/baw/commit/c6d0abaa42bd494916825b858dce6df6e7a7d791))

- **requirements**: Add utilo
  ([`1703c03`](https://github.com/anaticulae/baw/commit/1703c0380a62bd4b2bf2b5dc5b9bc8808213a0be))

### Code Style

- **pack**: Format code
  ([`86e19ad`](https://github.com/anaticulae/baw/commit/86e19ad4e14ecc88b9f14c261af1a9d8c63c68d8))

### Documentation

- **git**: Extend interface documentation
  ([`e4c9baf`](https://github.com/anaticulae/baw/commit/e4c9bafca069cde59af76c2faffcff32a0d19589))

### Features

- **git**: Add method to verify if current is release tag
  ([`f8b9d41`](https://github.com/anaticulae/baw/commit/f8b9d41880eb4ebef42189317909e43111a9af24))

- **semantic**: Run release on every commit
  ([`3624787`](https://github.com/anaticulae/baw/commit/3624787fbca1752c70a45868d0254bb8d96c18b5))
...
- **dependabot**: Remove invalid field
  ([`1264615`](https://github.com/anaticulae/baw/commit/126461580aba8fd5424f81af8e8104f3273acf87))

- **make**: Adjust template generation
  ([`14e20a6`](https://github.com/anaticulae/baw/commit/14e20a668bf1ae96e7a8fde8325a01c6b0233065))

- **pipe**: Verify that template is replaced
  ([`0345e38`](https://github.com/anaticulae/baw/commit/0345e38091f4dc2c7ab945cc8fe7e4614074aef4))

### Chores

- **release**: 1.73.1
  ([`0b21f1b`](https://github.com/anaticulae/baw/commit/0b21f1bbb034cef42248fda305ade94e415b0231))
...
- **docker**: Move to separate folder
  ([`de4ee34`](https://github.com/anaticulae/baw/commit/de4ee346676853f55269dd1a135a1d32824cba10))

- **github**: Fix version to increase reproduce ability
  ([`7eda681`](https://github.com/anaticulae/baw/commit/7eda681f5e68a2ff844891df9062c7e95cbb2044))

- **github**: Fix version to increase reproducibility
  ([`dce83c3`](https://github.com/anaticulae/baw/commit/dce83c3fac7af06b76e2fc60fbdc9dfa9f2dd2e1))

- **github**: Name dependabot action
  ([`40bf2e7`](https://github.com/anaticulae/baw/commit/40bf2e7a0a015740e32482e4bd2f839acc636f31))

- **github**: Use dependabot to update pip and docker
  ([`25acc0c`](https://github.com/anaticulae/baw/commit/25acc0c948caa28c2b4b2d7ece1b76a04c00b7e0))

- **pipe**: Organize imports
  ([`038b572`](https://github.com/anaticulae/baw/commit/038b572498d21826d4c6fcf40b2bfdcdc497b875))

- **release**: 1.73.0
  ([`5eb1c5b`](https://github.com/anaticulae/baw/commit/5eb1c5b907852712b54bbf5e2b922217bb87f472))

### Code Style

- **yapf**: Format code
  ([`e5d0ff9`](https://github.com/anaticulae/baw/commit/e5d0ff90ec8383d8bb819de5b69ffd793f32a725))

### Documentation

- **pipe**: Extend interface documentation
  ([`5e041f6`](https://github.com/anaticulae/baw/commit/5e041f64d714887143ee3259dabe4ce42b2c0ff6))

- **utils**: Extend interface
  ([`95920a6`](https://github.com/anaticulae/baw/commit/95920a6b734d0f353df08708d5ee7da21341a4fa))

### Features

- **github**: Add templates to init job
  ([`42d17bf`](https://github.com/anaticulae/baw/commit/42d17bf4327f59d967a1d20f43b455fd499bc69a))

- **pipe**: Add choices
  ([`1ccfba6`](https://github.com/anaticulae/baw/commit/1ccfba62fe138dc5221043ac42acbb60aaaff326))

- **pipe**: Add makefile
  ([`75f4f80`](https://github.com/anaticulae/baw/commit/75f4f800abb995b6d019e1db993e0dabe686c35a))

- **pipe**: Add method to determine github workflows path
  ([`047fdd8`](https://github.com/anaticulae/baw/commit/047fdd897369501bc4e5504cf841406b7621d507))

- **pipe**: Add parameter to change platform
  ([`9b1bf08`](https://github.com/anaticulae/baw/commit/9b1bf082c45d36c0a5060630ad7174339641b918))

- **pipe**: Generate .github workflows
  ([`0a40fa7`](https://github.com/anaticulae/baw/commit/0a40fa77369acac5b48894199fc4636711a80220))

- **resources**: Create github workflow on init
  ([`0c33a61`](https://github.com/anaticulae/baw/commit/0c33a6169424e03e19e04db2cdda03162c8ed6ee))

### Refactoring

- **pipe**: Clarify code
  ([`6f589ec`](https://github.com/anaticulae/baw/commit/6f589ecaf671e7e2292b33adeb062e518647d8ad))

- **resources**: Shorten code
  ([`64a5477`](https://github.com/anaticulae/baw/commit/64a54774f57d8b1b30b2c71fc8cd28c14389d160))

- **scripts**: Move alias script
  ([`afe3ee5`](https://github.com/anaticulae/baw/commit/afe3ee58e8af97212f86a13fc1b6f7471957d6e7))

### Testing

- **image**: Adjust to new interface
  ([`dfeaf6d`](https://github.com/anaticulae/baw/commit/dfeaf6d38ade9daa5e5edfec2b3c8313bacf933e))
...
- **pack**: Enable release type force
  ([`e106204`](https://github.com/anaticulae/baw/commit/e1062041a717767c648d882f59629fc441fc966d))

- **pack**: Ensure that correct parameter is used
  ([`53d1712`](https://github.com/anaticulae/baw/commit/53d171271546a22135c39140e77478cc0e3c52da))
...
- **github**: Use semantic release to publish
  ([`e665f6a`](https://github.com/anaticulae/baw/commit/e665f6a87db6a37c3a816e1e328ae4865166de8c))

- **release**: 1.72.0
  ([`384399f`](https://github.com/anaticulae/baw/commit/384399f2e7f9b4cbebf0c5948f4a468f181cee48))

- **release**: Do not create github release
  ([`1ea115a`](https://github.com/anaticulae/baw/commit/1ea115ab3a8b5f567e11c02742c87bc3604abc16))
...
- **release**: Setup git credentials
  ([`2b6155d`](https://github.com/anaticulae/baw/commit/2b6155dca07f16d3504db099cc82a5278d88910c))

- **release**: Use token
  ([`187cc1a`](https://github.com/anaticulae/baw/commit/187cc1a916aa4bd850efb879a29a3130bf7915c2))
...
- **pack**: Skip no release on ci
  ([`227775d`](https://github.com/anaticulae/baw/commit/227775d08ec1330a56239503f606a52ba91c8eb9))

- **semantic**: Upload release on ci
  ([`1af6bc6`](https://github.com/anaticulae/baw/commit/1af6bc617fe51657e9df6eaddd762d089ed85bd2))
...
- **pack**: Clarify naming
  ([`24e102f`](https://github.com/anaticulae/baw/commit/24e102f29e28bd9d29d3f23d82bdee9f4543a7bb))

- **release**: Improve code style
  ([`86811bc`](https://github.com/anaticulae/baw/commit/86811bc03f1b0f12183a9925fc0be9745e87a4d0))

- **release**: Improve naming
  ([`3a63fbe`](https://github.com/anaticulae/baw/commit/3a63fbe8c1d58b498c0b28dc854fe01b8c699e8f))
...
- **release**: 1.71.2
  ([`dcec93a`](https://github.com/anaticulae/baw/commit/dcec93ac08c95d15ce55a2fc166eaa956f76e463))
...
- **release**: 1.71.1
  ([`a5f5c6e`](https://github.com/anaticulae/baw/commit/a5f5c6e4773bde049bbf4c22cd2c9be09da51e51))
...
- **release**: 1.71.0
  ([`58ef751`](https://github.com/anaticulae/baw/commit/58ef7515bb11f2250444c9c7b05adf075bc18bda))
...
- **release**: 1.70.2
  ([`bd1fcdb`](https://github.com/anaticulae/baw/commit/bd1fcdb0b5d1c5121a59c2006f8c45c81d62993e))
...
- **release**: 1.70.1
  ([`d1da283`](https://github.com/anaticulae/baw/commit/d1da283cb77481a1b56b1b461a131983d1beb43d))
...
- **release**: 1.70.0
  ([`a85ec4d`](https://github.com/anaticulae/baw/commit/a85ec4d140e21447d6481388a3089c2bbf8a5570))
